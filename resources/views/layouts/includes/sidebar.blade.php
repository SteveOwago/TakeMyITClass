<nav class="navbar-vertical navbar">
    <div class="nav-scroller">
        ...
        <a class="navbar-brand" href="{{route('home')}}">
            <img src="backendIT/assets/images/brand/logo/logo.svg" alt="" />
        </a>
        <!-- Navbar nav -->
        <ul class="navbar-nav flex-column" id="sideNavbar">
            <li class="nav-item">
                <a class="nav-link has-arrow  active " href="{{route('home')}}">
            ...
            <!-- Nav item -->
            <li class="nav-item">
                <a class="nav-link has-arrow " href="{{route('customer-queries')}}" >
